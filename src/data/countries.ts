...
const countryNames: Record<string, { name: string; nameFr: string; funFact: string; capital: string; difficulty: 'FACILE' | 'DIFFICILE' }> = {
  // Europe
  FR: { name: "France", nameFr: "France", capital: "Paris", funFact: "Ce territoire hexagonal abrite la plus haute montagne d'Europe occidentale et compte plus de 400 variétés de fromages." , difficulty: "FACILE" },
  ...
  DE: { name: "Germany", nameFr: "Allemagne", capital: "Berlin", funFact: "Neuf pays sont ses voisins, ce qui en fait le pays européen avec le plus de frontières terrestres." , difficulty: "FACILE" },
  ES: { name: "Spain", nameFr: "Espagne", capital: "Madrid", funFact: "Sa superficie inclut des îles volcaniques au large de l'Afrique et une enclave en terre africaine." , difficulty: "FACILE" },
  ...
  GR: { name: "Greece", nameFr: "Grèce", capital: "Athènes", funFact: "Plus de 6 000 îles et îlots composent ce territoire, mais seulement 227 sont habités." , difficulty: "FACILE" },
  ...
  NL: { name: "Netherlands", nameFr: "Pays-Bas", capital: "Amsterdam", funFact: "Plus de 25% de son territoire se trouve sous le niveau de la mer, protégé par des digues." , difficulty: "FACILE" },
  ...
  IE: { name: "Ireland", nameFr: "Irlande", capital: "Dublin", funFact: "Cette île verte compte plus de moutons que d'habitants." , difficulty: "FACILE" },
  ...
  CZ: { name: "Czechia", nameFr: "Tchéquie", capital: "Prague", funFact: "Entièrement enclavé, ce territoire est traversé par deux grands fleuves européens." , difficulty: "FACILE" },
  ...
  UA: { name: "Ukraine", nameFr: "Ukraine", capital: "Kiev", funFact: "C'est le plus vaste pays entièrement situé en Europe, avec des steppes fertiles." , difficulty: "FACILE" },
  ...
  EE: { name: "Estonia", nameFr: "Estonie", capital: "Tallinn", funFact: "Plus de 2 000 îles composent ce territoire baltique dont la capitale est médiévale." , difficulty: "FACILE" },
  ...
  AL: { name: "Albania", nameFr: "Albanie", capital: "Tirana", funFact: "Ce petit territoire montagneux possède des côtes sur deux mers différentes." , difficulty: "FACILE" },
  MK: { name: "North Macedonia", nameFr: "Macédoine du Nord", capital: "Skopje", funFact: "Ce territoire enclavé tire son nom d'une région historique antique.", difficulty: "DIFFICILE" },
  SI: { name: "Slovenia", nameFr: "Slovénie", capital: "Ljubljana", funFact: "Malgré sa petite taille, ce territoire possède à la fois des Alpes et un accès à l'Adriatique.", difficulty: "DIFFICILE" },
  BA: { name: "Bosnia and Herzegovina", nameFr: "Bosnie-Herzégovine", capital: "Sarajevo", funFact: "Ce territoire présente une forme presque triangulaire avec un minuscule corridor vers la mer." , difficulty: "FACILE" },
  ...
  MD: { name: "Moldova", nameFr: "Moldavie", capital: "Chișinău", funFact: "Enclavé entre deux grands voisins, ce territoire est traversé par un affluent majeur.", difficulty: "DIFFICILE" },
  ...
  IN: { name: "India", nameFr: "Inde", capital: "New Delhi", funFact: "Cette immense péninsule triangulaire est bordée par trois mers différentes." , difficulty: "FACILE" },
  ...
  SG: { name: "Singapore", nameFr: "Singapour", capital: "Singapour", funFact: "Cette cité-État insulaire est l'un des plus petits pays du monde.", difficulty: "DIFFICILE" },
  ...
  IL: { name: "Israel", nameFr: "Israël", capital: "Jérusalem", funFact: "Ce petit territoire étroit borde la mer Méditerranée et le point le plus bas de la Terre.", difficulty: "DIFFICILE" },
  ...
  AF: { name: "Afghanistan", nameFr: "Afghanistan", capital: "Kaboul", funFact: "Territoire montagneux et enclavé, surnommé le \"toit du monde\"." , difficulty: "FACILE" },
  NP: { name: "Nepal", nameFr: "Népal", capital: "Katmandou", funFact: "Enclavé dans l'Himalaya, ce territoire abrite 8 des 10 plus hauts sommets du monde." , difficulty: "FACILE" },
  ...
  MM: { name: "Myanmar", nameFr: "Myanmar", capital: "Naypyidaw", funFact: "Ce territoire s'étire du nord au sud sur plus de 2 000 km entre montagnes et mer." , difficulty: "FACILE" },
  ...
  // Océanie
  AU: { name: "Australia", nameFr: "Australie", capital: "Canberra", funFact: "Le plus grand pays-continent de l'Océanie, également la plus grande île du monde." , difficulty: "FACILE" },
  ...
  PG: { name: "Papua New Guinea", nameFr: "Papouasie-Nouvelle-Guinée", capital: "Port Moresby", funFact: "Ce territoire occupe la moitié orientale d'une grande île tropicale." , difficulty: "FACILE" },
  ...
  // Amérique du Nord
  US: { name: "United States", nameFr: "États-Unis", capital: "Washington", funFact: "Le quatrième plus grand pays du monde possède deux territoires non-contigus majeurs." , difficulty: "FACILE" },
  CA: { name: "Canada", nameFr: "Canada", capital: "Ottawa", funFact: "Le deuxième plus grand pays du monde partage la plus longue frontière terrestre avec un seul voisin." , difficulty: "FACILE" },
  ...
  GT: { name: "Guatemala", nameFr: "Guatemala", capital: "Guatemala", funFact: "Ce territoire montagneux volcanique abrite des vestiges mayas légendaires." , difficulty: "FACILE" },
  ...
  NI: { name: "Nicaragua", nameFr: "Nicaragua", capital: "Managua", funFact: "Le plus grand pays d'Amérique centrale abrite deux immenses lacs." , difficulty: "FACILE" },
  ...
  JM: { name: "Jamaica", nameFr: "Jamaïque", capital: "Kingston", funFact: "Cette île montagneuse des Caraïbes est la troisième plus grande des Grandes Antilles." , difficulty: "FACILE" },
  ...
  DO: { name: "Dominican Republic", nameFr: "République Dominicaine", capital: "Saint-Domingue", funFact: "Occupant les deux tiers est d'une île, ce territoire possède le point le plus haut des Caraïbes." , difficulty: "FACILE" },
  
  // Amérique du Sud
  BR: { name: "Brazil", nameFr: "Brésil", capital: "Brasília", funFact: "Le cinquième plus grand pays du monde occupe presque la moitié du continent sud-américain." , difficulty: "FACILE" },
  ...
  CL: { name: "Chile", nameFr: "Chili", capital: "Santiago", funFact: "Le pays le plus long et étroit du monde s'étend sur 4 300 km le long du Pacifique." , difficulty: "FACILE" },
  ...
  VE: { name: "Venezuela", nameFr: "Venezuela", capital: "Caracas", funFact: "Les chutes les plus hautes du monde tombent d'un plateau de ce territoire." , difficulty: "FACILE" },
  ...
  BO: { name: "Bolivia", nameFr: "Bolivie", capital: "La Paz", funFact: "L'un des deux pays enclavés du continent abrite le plus grand désert de sel du monde." , difficulty: "FACILE" },
  ...
  GY: { name: "Guyana", nameFr: "Guyana", capital: "Georgetown", funFact: "Seul pays anglophone d'Amérique du Sud, couvert à 80% par la forêt amazonienne.", difficulty: "DIFFICILE" },
  ...
  GH: { name: "Ghana", nameFr: "Ghana", capital: "Accra", funFact: "Ce territoire côtier fut le premier pays d'Afrique subsaharienne à obtenir l'indépendance." , difficulty: "FACILE" },
  ...
  UG: { name: "Uganda", nameFr: "Ouganda", capital: "Kampala", funFact: "Traversé par l'équateur, ce territoire enclavé possède la source du plus long fleuve du monde." , difficulty: "FACILE" },
  ...
  CM: { name: "Cameroon", nameFr: "Cameroun", capital: "Yaoundé", funFact: "Sa forme triangulaire lui vaut le surnom d'\"Afrique en miniature\" pour sa diversité." , difficulty: "FACILE" },
  ...
  MZ: { name: "Mozambique", nameFr: "Mozambique", capital: "Maputo", funFact: "Ce territoire s'étire sur plus de 2 500 km le long de l'océan Indien." , difficulty: "FACILE" },
  ZW: { name: "Zimbabwe", nameFr: "Zimbabwe", capital: "Harare", funFact: "Ce territoire enclavé abrite les spectaculaires chutes Victoria sur sa frontière." , difficulty: "FACILE" },
  ...
  ZM: { name: "Zambia", nameFr: "Zambie", capital: "Lusaka", funFact: "Sans accès à la mer, ce territoire en forme de papillon possède le plus grand barrage d'Afrique." , difficulty: "FACILE" },
  ...
  TD: { name: "Chad", nameFr: "Tchad", capital: "N'Djamena", funFact: "Ce territoire enclavé abrite un lac qui change de taille selon les saisons." , difficulty: "FACILE" },
  ...
  MW: { name: "Malawi", nameFr: "Malawi", capital: "Lilongwe", funFact: "Ce territoire étroit et enclavé est dominé par un immense lac sur toute sa longueur.", difficulty: "DIFFICILE" },
  ...
  CG: { name: "Republic of the Congo", nameFr: "République du Congo", capital: "Brazzaville", funFact: "Ce territoire forestier est traversé par l'équateur et bordé par le grand fleuve éponyme." , difficulty: "FACILE" },
  ...
  CF: { name: "Central African Republic", nameFr: "République Centrafricaine", capital: "Bangui", funFact: "Comme son nom l'indique, ce territoire enclavé se situe au centre du continent.", difficulty: "DIFFICILE" },
  ...
  BJ: { name: "Benin", nameFr: "Bénin", capital: "Porto-Novo", funFact: "Ce territoire étroit s'étire du nord au sud sur 700 km jusqu'au golfe de Guinée.", difficulty: "DIFFICILE" },
  ...
  SS: { name: "South Sudan", nameFr: "Soudan du Sud", capital: "Djouba", funFact: "Le plus jeune pays du monde (2011) est enclavé au cœur de l'Afrique." , difficulty: "FACILE" },
  ...
  // Russie
  RU: { name: "Russia", nameFr: "Russie", capital: "Moscou", funFact: "Le plus vaste pays du monde s'étend sur deux continents et traverse 11 fuseaux horaires." , difficulty: "FACILE" },
  ...
  AM: { name: "Armenia", nameFr: "Arménie", capital: "Erevan", funFact: "Ce territoire montagneux et enclavé abrite le mont biblique légendaire.", difficulty: "DIFFICILE" },
